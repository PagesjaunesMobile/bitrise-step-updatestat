...
//DEPS me.lazmaid.kraph:kraph:0.7.0 com.google.code.gson:gson:2.8.6 com.github.kittinunf.fuel:fuel:2.3.1 com.github.kittinunf.fuel:fuel-coroutines:2.3.1
//INCLUDE data.kt
//INCLUDE bash.kt
